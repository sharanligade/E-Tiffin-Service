...
.btn-primary:hover {
    ...
    <body>
        ...
        <p align="center"><a href="agentdashboard.jsp" class="btn btn-primary">Dashboard</a>  &nbsp;  &nbsp; <a href="agentsignout.jsp" class="btn btn-primary" style="background-color: red;">Sign Out</a> &nbsp;  </p></p>
    </body>
</html>
