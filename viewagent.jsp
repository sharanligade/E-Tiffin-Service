...
.btn-primary:hover {
    ...
    <body>
        ...
        ResultSet rs=st.executeQuery("select * from agent where flag=0");
        while(rs.next())
        {
            out.println("<tr>");
            int aa=rs.getInt(1);
            ...
            out.println("<td><a href=approvea.jsp?id="+aa+">Approve</a>");
            out.println("<td><a href=rejecta.jsp?id="+aa+">Reject</a>");
        }
